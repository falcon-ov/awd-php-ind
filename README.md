...
Маршруты приложения реализованы в app/routes.php с использованием простого подхода на основе switch-case. Каждый маршрут соответствует определённому URL и вызывает метод контроллера.
